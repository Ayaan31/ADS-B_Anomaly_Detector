...
def plot_clusters(X_scaled: pd.DataFrame, labels: np.ndarray,
                  anomaly_scores: Optional[np.ndarray] = None, save: bool = True) -> plt.Figure:
...
def plot_geographic(flight_df: pd.DataFrame, label_col: str = "cluster",
                    score_col: Optional[str] = "anomaly_distance", save: bool = True) -> plt.Figure:
    """
...
def plot_voronoi(flight_df: pd.DataFrame, seed_points: Optional[np.ndarray] = None,
                 label_col: str = "cluster", save: bool = True) -> plt.Figure:
    """
